        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">Editar Cuestionario</div>
                    <div class="panel-body">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <div class="row">
                                    <form id="form-questionary" action="{{ route('questionary.update', $questionary->id) }}" method="POST" accept-charset="UTF-8" class="form-horizontal">
                                        {{ method_field('PATCH') }}
                                        {{ csrf_field() }}
                                        <div class="col-md-4">
                                            <div class="form-group {{ $errors->has('name') ? 'has-error' : ''}}">
                                                <label for="name" class="control-label">Nombre</label>
                                                <input type="text" name="name" class="form-control" value="{{ $questionary->name or ''}}" required>
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group col-md-12 {{ $errors->has('description') ? 'has-error' : ''}}">
                                                ...
                                                <textarea class="form-control" rows="1" name="description" type="textarea">{{ $questionary->description or ''}}</textarea>
...
@section("scripts")
    <script>
        ...
        @else
            var formData = `{!! json_encode($questionary->form) !!}`;
        @endif
