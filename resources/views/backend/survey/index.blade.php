                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="ibox float-e-margins">
                            <a href="{{ route('survey.create') }}" class="btn btn-success btn-sm" title="Crear nueva Sede">
                                        ...
                                        <table class="table table-striped table-bordered table-hover dataTables-example dataTable dtr-inline">
                                            ...
                                            @foreach($surveys as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('survey.show', $item->id) }}" title="Ver Periodo">
                                                            <button class="btn btn-info btn-xs"><i class="fa fa-eye" aria-hidden="true"></i> Ver</button>
                                                        </a>
                                                        <a href="{{ route('survey.edit', $item->id) }}" title="Editar Periodo">
                                                            <button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Editar</button>
                                                        </a>
                                                        <form method="POST" action="{{ route('survey.destroy', $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                                            {{ method_field('DELETE') }}
                                                            {{ csrf_field() }}
